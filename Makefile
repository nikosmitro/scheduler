...
all: scheduler scheduler-shell shell scheduler-shell-hl prog prog2 execve-example strace-test sigchld-example
...
scheduler-shell-hl: scheduler-shell-hl.o proc-common.o
	$(CC) -o scheduler-shell-hl scheduler-shell-hl.o proc-common.o
...
prog2: prog2.o proc-common.o
	$(CC) -o prog2 prog2.o proc-common.o
...
scheduler-shell-hl.o: scheduler-shell-hl.c proc-common.h request.h
	$(CC) $(CFLAGS) -o scheduler-shell-hl.o -c scheduler-shell-hl.c

prog.o: prog.c
	$(CC) $(CFLAGS) -o prog.o -c prog.c

prog2.o: prog2.c
	$(CC) $(CFLAGS) -o prog2.o -c prog2.c
...
clean:
	rm -f scheduler scheduler-shell shell scheduler-shell-hl prog 	prog2 execve-example strace-test 	sigchld-example *.o
